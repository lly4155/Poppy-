...
- (void)setup
{
    ...
    UIBarButtonItem *rightBarItem = [[UIBarButtonItem alloc] initWithTitle:@"取消" style:UIBarButtonItemStyleDone target:self action:@selector(cancelDidClick)];
    [rightBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:                                        [UIFont fontWithName:@"Helvetica-Bold" size:17.0], NSFontAttributeName,                                        [UIColor colorWithRed:213/255.0 green:24/255.0 blue:37/255.0 alpha:0.8], NSForegroundColorAttributeName,                                        nil] forState:UIControlStateNormal];

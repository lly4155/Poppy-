                          ...
                          internalAnimationFactor:(CGFloat)internalAnimationFactor
{
    ...
    for (int i=0; i<startPoints.count; i++) {
        ...
        BarItem *barItem = [[BarItem alloc] initWithFrame:refreshControl.frame startPoint:startPoint endPoint:endPoint color:[UIColor colorWithRed:1 green:99/255.0 blue:71/255.0 alpha:1] lineWidth:lineWidth];
        barItem.tag = i;
        barItem.alpha = 0;

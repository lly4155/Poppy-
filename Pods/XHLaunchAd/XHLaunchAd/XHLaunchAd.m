...
-(void)remove{
    ...
    [UIView transitionWithView:[[UIApplication sharedApplication].delegate window] duration:0.7 options: UIViewAnimationOptionTransitionFlipFromRight animations:^{
